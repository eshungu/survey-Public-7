                                    ...
                                    <table id="exportTable" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                @if($response->responseValue == 4)
                                                <td>{{$response->percentage }}%</td>
                                                @endif

                                                @if($response->responseValue == 5)
                                                <td>{{$response->percentage }}%</td>
                                                @endif

                                                <!-- --------- -->
<!-- 
                                                @if($response->responseValue == 6)
                                                <td>{{$response->percentage }}%</td>
                                                @endif

                                                @if($response->responseValue == 7)
                                                <td>{{$response->percentage }}%</td>
                                                @endif

                                                @if($response->responseValue == 8)
                                                <td>{{$response->percentage }}%</td>
                                                @endif

                                                @if($response->responseValue == 9)
                                                <td>{{$response->percentage }}%</td>
                                                @endif

                                                @if($response->responseValue == 10)
                                                <td>{{$response->percentage }}%</td>
                                                @endif -->
                                                ...
                                                <!-- <td>{{$question->average*2}}/10</td> -->

                                                <td>{{$question->average}}/5</td>

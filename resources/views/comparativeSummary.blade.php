...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
                        ...
                        <div class="content flex-column-fluid" id="kt_content">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    {{$question[0]->questionContent}}                                    

                                    <table id="exportTable" class="table table-hover">
                                        <thead>
                                            <tr>
                                                <!-- <th></th> -->
                                                <th>Access Bank Rwanda</th>
                                                <th>Bank of Kigali</th>
                                                <th>Commercial Bank of Rwanda</th>
                                                <th>Banque Populaire du Rwanda</th>
                                                <th>Cogebanque</th>
                                                <th>Ecobank</th>
                                                <th>Equity Bank</th>
                                                <th>Fina Bank</th>
                                                <th>Banque de l’Habitat du Rwanda</th>
                                                <th>Rwanda Development Bank</th>
                                                <th>Kenya Commercial Bank</th>
                                                <th>Urwego Opportunity Bank (UOB)</th>
                                        ...
                                        <tbody>                                                                                 
                                            ...
                                            @foreach($question[0]->forms as $form) 

                                                <!-- <td></td> -->

                                                @if($form->formId == 1 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 1 && $form->average  == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 2 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 2 && $form->average  == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 3 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 3 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 4 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 4 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 5 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 5 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 6 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 6 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 7 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 7 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 8 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 8 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 9 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 9 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 10 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 10 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 11 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 11 && $form->average == '-')
                                                <td>-</td>
                                                @endif

                                                @if($form->formId == 12 && $form->average != '-')
                                                <td>{{$form->average }}/5</td>
                                                @elseif($form->formId == 12 && $form->average == '-')
                                                <td>-</td>
                                                @endif
                                ...
                                <div>
                                    ...
                                    <div>
                                        ...
                                        <a href="/exportToExcelResultsSum/{{$form->formId}}">
    ...
    <script src="assets/js/pages/crud/datatables/basic/scrollable.js?v=7.0.3"></script>
    <!--end::Page Scripts-->
